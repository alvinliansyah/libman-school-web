...
class HistoryController extends Controller
{
    public function history(Request $request)
    {
        ...
        $query = "SELECT data_buku.id_buku,data_buku.judul_buku, data_buku.gambar, data_buku.semester,data_buku.penerbit,data_buku.jumlah, pengembalian.tanggal_pengembalian,pengembalian.NIS,peminjaman.tanggal_peminjaman
